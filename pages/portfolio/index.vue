<template>
  <div class="h-full w-full flex flex-center flex-col bg-gray-900 ">
    <div class="flex flex-wrap flex-row space-x-2 space-y-2 w-full h-full justify-center overflow-y-auto pt-3 main mb-2">
      <div class="max-w-xs rounded overflow-hidden bg-gray-800 card shadow-lg my-2 h-auto">
        <img class="w-full" src="/dash.png" alt="Sunset in the mountains">
        <div class="px-6 py-1">
          <div class="font-bold text-xl mb-2 text-gray-200">
            Open Cart Admin
          </div>
          <p class="text-grey-darker text-base text-gray-300">
            An open cart admin is an e-commerce admin dashboard which consumes the OPEN-CART_ADMIN API developed with laravel. Build with Quasar, a Vue JS framework with typescript
          </p>
        </div>
        <div class="px-6 py-1">
      ...
      <div class="max-w-xs rounded overflow-hidden bg-gray-800 card shadow-lg my-2 h-auto">
        <img class="w-full" src="/open-cart.png" alt="Sunset in the mountains">
        <div class="px-6 py-1">
          <div class="font-bold text-xl mb-2 text-gray-200">
            Open Cart API
          </div>
